...
Entity {
    ...
    Entity {
        Mesh {
            id: mesh
            source: Paths.getModelPath("silver_paint_2.obj")
        }
    ...
    Entity {
        Mesh {
            id: glass
            source: Paths.getModelPath("glass_2.obj")
        }
    ...
    Entity {
        Mesh {
            id: chrome
            source: Paths.getModelPath("chrome_3.obj")
        }
    ...
    Entity {
        Mesh {
            id: black
            source: Paths.getModelPath("black_right.obj")
        }
    ...
    Entity {
        Mesh {
            id: black1
            source: Paths.getModelPath("black_3.obj")
        }
